  ...
  return (
    <div className=" flex sm:flex-col md:flex-col gap-[1rem] sm:bg-[#E4E9FF] sm:min-w-[24rem]">
      ...
      <div className="md:px-[1rem] lg:w-full">
        <div className="flex-1 pt-[3rem] pb-[2rem]">
        ...
        {displayMeals.map((dailyMeal) => (
          <div
            key={dailyMeal.recordDate}
            className="relative mb-[2rem] lg:mr-[4.875rem]"
          >
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4 sm:px-4 ">
              {(
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-[2.0625rem] mt-8 ">
              <TextBox
                title="AI 분석 결과"
