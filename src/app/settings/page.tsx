        ...
        <section className="mb-8">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <button
              ...
              className={`flex-1 p-4 rounded-lg border-2 transition-all bg-white dark:bg-gray-800 min-h-[72px] active:scale-[0.98] ${
                theme === 'light'
            ...
            >
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 sm:w-10 sm:h-10 rounded-lg bg-slate-100 dark:bg-gray-700 border border-slate-200 dark:border-gray-600 flex items-center justify-center flex-shrink-0">
            ...
            >
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 sm:w-10 sm:h-10 rounded-lg bg-gray-900 border border-gray-700 flex items-center justify-center flex-shrink-0">
