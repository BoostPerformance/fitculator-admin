...
// console.error('조직 추가 오류:', err);
 ...
 {/* 조직 목록 */}
 <div className="w-full md:w-1/3 bg-surface rounded-lg shadow p-4">
 ...
 className="mb-4 p-3 bg-surface-raised rounded-md"
 >
 <div className="mb-3">
 ...
 <div className="w-10 h-10 mr-3 rounded-full bg-surface-sunken flex items-center justify-center">
 <span className="text-content-tertiary text-lg font-semibold">
 ...
 {/* 조직 상세 정보 및 멤버 */}
 <div className="w-full md:w-2/3 bg-surface rounded-lg shadow p-4">
 {selectedOrganization ? (
 <>
 <div className="mb-6">
 ...
 <button className="text-blue-100 hover:text-blue-700 dark:text-blue-300 mr-2">
 편집
 </button>
 <button className="text-red-500 dark:text-red-400 hover:text-red-700">
 삭제
 </button>
 </td>
 </tr>
