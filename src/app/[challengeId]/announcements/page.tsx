...
export default function AnnouncementsPage() {
 ...
 <SelectItem value="archived" className="dark:text-white dark:focus:bg-neutral-700">보관됨</SelectItem>
 </SelectContent>
 </Select>
 </div>
 </div>
 ...
 <div
 key={announcement.id}
 className="p-4 active:bg-slate-50 dark:active:bg-neutral-700/50 cursor-pointer transition-colors"
