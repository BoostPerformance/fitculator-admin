...
export default function AnnouncementDetailPage() {
 ...
 return (
 <div key={dayKey} className="border border-slate-200 rounded-lg overflow-hidden">
 <button
 onClick={() => toggleDayExpansion(dayKey)}
 className="w-full px-4 py-3 flex justify-between items-center hover:bg-slate-50/50 transition-colors"
 >
 <div className="flex items-center gap-3">
 <span className="font-medium text-slate-900">{day.korean_name}</span>
 ...
 <div className="border-t border-slate-200 p-4 bg-slate-50/50/50">
 ...
 <div className="bg-surface rounded-lg p-3 border border-slate-200">
