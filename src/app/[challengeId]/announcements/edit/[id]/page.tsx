...
function AbbreviationInput({ onAdd }: { onAdd: (key: string, value: string) => void }) {
 ...
 className="px-2 py-1.5 text-sm border border-slate-200 rounded-lg w-20 focus:outline-none focus:ring-2 focus:ring-slate-900 dark:focus:ring-white bg-surface text-slate-900"
 placeholder="약어"
 />
 <input
 type="text"
 ...
 onKeyPress={handleKeyPress}
 className="flex-1 px-2 py-1.5 text-sm border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-slate-900 dark:focus:ring-white bg-surface text-slate-900"
 placeholder="설명"
 />
 <button
 type="button"
...
export default function EditAnnouncementPage() {
 ...
 // 기존 텍스트를 Tiptap JSON으로 변환하는 함수
 const convertTextToTiptap = (text: string): object => {
 ...
 // content를 Tiptap JSON 또는 레거시 형식으로 처리
 let editorContent: object = { type: 'doc', content: [] };
 if (data.type === 'general') {
 if (data.content?.type === 'doc') {
 // 이미 Tiptap JSON 형식인 경우
 editorContent = data.content;
 } else if (data.content?.text) {
 // 레거시 { text: string } 형식인 경우 Tiptap JSON으로 변환
 editorContent = convertTextToTiptap(data.content.text);
 }
 ...
 <h1 className="text-2xl font-semibold text-slate-900 dark:text-white tracking-tight">공지사항 수정</h1>
 <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">공지사항 내용을 수정합니다</p>
 </div>
 ...
 className="w-full px-3 py-2 text-sm border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-slate-900 dark:focus:ring-white focus:border-transparent transition-shadow bg-surface text-slate-900"
 />
 </div>
 ...
 className="w-full px-3 py-2 text-sm border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-slate-900 dark:focus:ring-white focus:border-transparent bg-surface text-slate-900"
 >
 ...
 className="w-4 h-4 rounded border-slate-300 text-slate-900 dark:text-white focus:ring-slate-900 dark:focus:ring-white"
 />
 ...
 ? 'bg-slate-900 dark:bg-surface text-white dark:text-slate-900 border-slate-900 dark:border-white'
 : 'bg-surface text-slate-600 dark:text-slate-300 border-slate-200 hover:border-slate-300 dark:hover:border-line-strong'
 }`}
 >
 전체
 </button>
 ...
 <div key={sessionIndex} className="bg-slate-50 rounded-lg p-3 space-y-3">
 ...
 className="w-full px-2 py-1.5 text-sm border border-slate-200 rounded-lg bg-surface text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-slate-900 dark:focus:ring-white"
 >
 ...
 className="w-full px-2 py-1.5 text-sm border border-slate-200 rounded-lg bg-surface text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-slate-900 dark:focus:ring-white resize-none"
 rows={2}
 ...
 className="w-full px-2 py-1.5 text-sm border border-slate-200 rounded-lg bg-surface text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-slate-900 dark:focus:ring-white resize-none font-mono"
 rows={4}
 placeholder="운동 내용"
 />
 </div>
 ...
 className="w-full px-3 py-2 text-sm border border-slate-200 rounded-lg bg-surface text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-slate-900 dark:focus:ring-white resize-none"
 rows={2}
 />
 </div>
 ...
 <span className="px-2 py-1 text-xs bg-slate-100 rounded font-medium text-slate-700 dark:text-slate-300 min-w-[60px]">{key}</span>
 ...
 type="submit"
 disabled={loading}
 className="px-4 py-2 text-sm bg-slate-900 dark:bg-surface text-white dark:text-slate-900 rounded-lg hover:bg-slate-800 disabled:opacity-50 transition-colors"
 >
 {loading ? '저장 중...' : '저장하기'}
 </button>
 </div>
