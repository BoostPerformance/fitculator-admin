...
export default function MembersPage() {
 ...
 <div className="w-10 h-10 bg-surface/20 rounded-xl flex items-center justify-center flex-shrink-0 sm:w-8 sm:h-8 sm:rounded-lg">
 ...
 className="px-4 py-2.5 rounded-xl bg-surface/20 text-white border-0 font-medium text-sm focus:outline-none focus:ring-2 focus:ring-white/50 cursor-pointer min-h-[44px] sm:flex-1 sm:px-3 sm:rounded-lg"
 >
 ...
 className="px-4 py-2.5 bg-surface/20 text-white rounded-xl hover:bg-surface/30 transition-colors font-medium text-sm min-h-[44px] sm:px-3 sm:rounded-lg"
 >
 취소
 </button>
 </div>
 ...
 >
 <div
 className="bg-surface w-full sm:max-w-lg sm:rounded-2xl rounded-t-2xl shadow-2xl animate-in sm:zoom-in-95 slide-in-from-bottom duration-300 max-h-[85vh] flex flex-col"
 ...
 >
 <div
 className="bg-surface w-full sm:max-w-md sm:rounded-2xl rounded-t-2xl shadow-2xl animate-in sm:zoom-in-95 slide-in-from-bottom duration-300 max-h-[90vh] flex flex-col"
 onClick={(e) => e.stopPropagation()}
 >
 {/* 모바일 드래그 핸들 */}
 <div className="sm:hidden flex justify-center pt-3 pb-1">
