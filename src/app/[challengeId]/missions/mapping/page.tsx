...
// console.error('Error saving mapping:', error);
 ...
 className="w-full px-3 py-2 border border-line rounded-md disabled:bg-surface-raised"
 >
 ...
 className="w-full px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 disabled:bg-neutral-400"
 >
 매핑 저장
 </button>
 </div>
 ...
 {/* 운동 목록 */}
 {showWorkouts && (
 <div className="mt-6 bg-surface rounded-lg shadow">
 <div className="p-6">
 ...
 {workout.note && (
 <p className="text-sm text-content-tertiary mt-1">{workout.note}</p>
 )}
 </div>
 </div>
 </div>
