...
// console.error('복사 실패:', err);
 ...
 {title && (
 <h4 className="text-headline font-bold font-semibold mb-2 flex items-center ">
 {title}
 {copyIcon && (
 ...
 <div
 className="absolute top-[0.5rem] left-[10rem] bg-green-100 dark:bg-green-900/20 text-green-800 dark:text-green-300 text-title font-medium p-[0.5rem] rounded-[0.5rem] 
 ...
 className={`border p-2 w-full rounded-md text-body dark:bg-surface ${
 readOnly ? 'bg-surface-raised cursor-not-allowed' : ''
 ...
 {button2 && (
 <button
 className={`${Btn2className} flex flex-row gap-1 justify-center items-center rounded-md text-body w-[149px] p-[0.375rem] sm:w-full`}
 onClick={onClick2}
 >
 {svg2 && (
 <Image
