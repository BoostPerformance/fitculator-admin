...
const EditUsernameModal: React.FC<EditUsernameModalProps> = ({
 ...
 <h2 className="text-lg font-semibold text-content-primary">이름 수정</h2>
 <button
 onClick={handleClose}
 className="w-10 h-10 flex items-center justify-center rounded-full text-content-tertiary hover:bg-surface-raised active:bg-surface-sunken transition-colors"
 aria-label="닫기"
 >
 <FaTimes size={18} />
 </button>
 ...
 className="w-full px-4 py-3 border border-line rounded-xl text-base focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:text-white transition-all min-h-[48px]"
 ...
 <button
 onClick={handleClose}
 className="flex-1 py-3 px-6 text-content-secondary bg-surface-raised hover:bg-surface-sunken active:bg-surface-sunken rounded-xl font-medium transition-colors min-h-[48px]"
 disabled={isLoading}
 >
 취소
 </button>
 ...
 <button
 onClick={handleCancelClose}
 className="flex-1 py-3 px-4 text-content-secondary bg-surface-raised rounded-xl font-medium hover:bg-surface-sunken active:bg-surface-sunken transition-colors min-h-[48px]"
 >
 계속 수정
 </button>
 <button
