const TotalFeedbackCounts = ({
  ...
  return (
    <div
      className={`mt-[1rem] flex flex-col py-[1.25rem] lg:w-full bg-white justify-center border-b-[0.4rem] ${borderColor} px-[1.3rem] rounded-[0.2rem] drop-shadow-md ${grids} sm:items-center sm:gap-[0.6rem] md:items-center md:w-[9.5rem] md:p-0 md:py-[1rem] `}
    >
