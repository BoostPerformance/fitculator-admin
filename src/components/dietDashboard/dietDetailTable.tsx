...
const DietDetaileTable = ({
 ...
 } text-white rounded-[0.3rem] text-body font-medium whitespace-nowrap`}
 >
...
// console.error('Date formatting error:', error);
 ...
 {/* 컨테이너 추가 */}
 <table className="w-full bg-surface shadow-md rounded-md border border-line">
 <thead>
 <tr className="bg-surface text-content-disabled">
 ...
 className="text-content-tertiary hover:bg-[#F4F6FC] cursor-pointer border-line border-b-[0.1rem]"
 onClick={() =>
 router.push(
