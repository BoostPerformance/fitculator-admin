...
const DailyWorkoutRecord = ({
 ...
 if (loading) {
 return (
 <div className="bg-surface rounded-lg p-3 col-span-2 h-[36rem] flex items-center justify-center">
 <div className="text-content-tertiary">로딩 중...</div>
 </div>
 );
 }
 ...
 return (
 <div className="bg-surface rounded-lg p-3 col-span-2 h-[36rem] flex items-center justify-center shadow-[0_0_12px_0_rgba(121,120,132,0.15)] dark:shadow-none border border-line">
 <div className="text-center">
 <div className="text-content-tertiary mb-2">일별 운동 기록 현황</div>
 <div className="text-content-disabled text-sm">운동 기록이 없습니다.</div>
 </div>
 </div>
 );
 }
 ...
 return (
 <div className="bg-surface rounded-lg p-4 col-span-2 overflow-y-auto h-[36rem] [&::-webkit-scrollbar]:!hidden [scrollbar-width:none] shadow-[0_0_12px_0_rgba(121,120,132,0.15)] dark:shadow-none border border-line">
 <div className="flex justify-between items-center mb-4">
 <h2 className="text-lg font-semibold text-content-tertiary pt-3">
 일별 운동 기록 현황
 </h2>
 </div>
 {/* 헤더 부분 */}
 ...
 <div
 key={idx}
 className="flex justify-center text-content-tertiary lg:text-label font-medium sm:text-body font-medium"
 >
 {day}
 </div>
 ))}
 ...
 {/* 전체 현황 헤더 */}
 <div className="col-span-2 flex justify-end pr-2 text-content-tertiary lg:text-label font-medium md:text-body font-medium sm:text-body font-medium pt-[1rem]">
 전체
 </div>
 </div>
 ...
 weekDate.hasWorkout ? 'bg-[#FAAA16]' : 'bg-surface-raised'
 }`}
 />
 </div>
 ))}
 ...
 <span className="text-content-secondary text-body font-medium">
