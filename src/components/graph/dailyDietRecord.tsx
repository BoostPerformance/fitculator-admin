...
const DailyDietRecord = ({
 ...
 return (
 <div className="bg-surface rounded-lg p-3 col-span-2 overflow-y-auto h-[36rem] [&::-webkit-scrollbar]:!hidden [scrollbar-width:none] shadow-[0_0_12px_0_rgba(121,120,132,0.15)] dark:shadow-none border border-line">
 <div className="flex justify-between items-center mb-4">
 <h2 className="text-lg font-semibold text-content-tertiary pt-4 pl-1">
 일별 식단 기록 현황
 </h2>
 </div>
 {/* 헤더 부분 */}
 ...
 {/* 총 업로드 현황 헤더 */}
 <div className="col-span-2 flex justify-center text-content-tertiary lg:text-label font-medium md:text-body font-medium sm:text-body font-medium text-center pt-[1rem]">
 총 업로드
 ...
 <span className="text-content-secondary text-label-xs font-medium">
