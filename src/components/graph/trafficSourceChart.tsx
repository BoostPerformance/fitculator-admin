...
export default function TrafficSourceChart({
 ...
 return (
 <div className="bg-surface p-4 shadow dark:shadow-neutral-900 rounded-lg col-span-2 h-[36rem] overflow-y-auto [&::-webkit-scrollbar]:hidden hover:[&::-webkit-scrollbar]:block [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:bg-neutral-300 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-600 [&::-webkit-scrollbar-track]:bg-surface-raised dark:[&::-webkit-scrollbar-track]:bg-neutral-700 border border-line">
 <h2 className="text-lg font-semibold mb-4 text-content-tertiary pt-3">
 인기운동
 </h2>
 {(isLoading || internalLoading) ? (
 <div className="flex items-center justify-center h-64">
 <p className="text-content-tertiary">데이터를 불러오는 중...</p>
 </div>
 ) : error ? (
 <div className="flex items-center justify-center h-64">
 ...
 <span className="w-6 font-medium text-[14px] text-content-tertiary">
 {exercise.rank}
 </span>
 <span className="flex-1 font-medium text-[14px] text-content-tertiary">
 {exercise.name}
 </span>
 <span className="font-medium text-[14px] text-content-tertiary">
 {exercise.percentage}
 </span>
 </li>
 )
