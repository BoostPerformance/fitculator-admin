...
const generateBarChart = (
 ...
 return (
 <div className="h-48 sm:h-64 w-full flex items-center justify-center text-content-disabled text-sm lg:h-64">
 ...
 {/* Y축 눈금 */}
 <div className="absolute left-0 h-[90%] flex flex-col justify-between text-content-tertiary text-[10px] sm:text-xs">
 <div>100</div>
 <div>50</div>
 <div>0</div>
 </div>
 ...
 statusColors[day.status] || 'bg-neutral-300'
 }`}
 style={{
 height: `${barHeight}%`,
 minHeight: '2px',
 ...
 {/* 요일 */}
 <div className="text-[10px] sm:text-xs text-content-tertiary mt-2 absolute -bottom-6 left-0 right-0 text-center">
 {day.day}
 </div>
 </div>
 );
...
const generateDonutChart = (
 ...
 return (
 <div className="relative w-full flex flex-col items-center justify-center py-4 sm:py-8 text-content-disabled text-xs sm:text-sm">
