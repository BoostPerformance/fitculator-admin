...
const WeeklyWorkoutChart: React.FC<WeeklyWorkoutChartProps> = ({
 ...
 if (isLoading) {
 return (
 <div className="col-span-6 sm:col-span-6 md:col-span-6 lg:col-span-6 bg-surface p-4 md:p-6 shadow rounded-lg flex items-center justify-center h-40 md:h-64">
 <p className="text-content-tertiary text-sm md:text-base">
 데이터를 불러오는 중...
 </p>
 </div>
 );
 ...
 if (error) {
 return (
 <div className="col-span-6 sm:col-span-6 md:col-span-6 lg:col-span-6 bg-surface p-4 md:p-6 shadow rounded-lg flex flex-col items-center justify-center h-40 md:h-64">
 <p className="text-red-500 dark:text-red-400 mb-2 md:mb-4 text-sm md:text-base">
 {error}
 </p>
 <button
 onClick={() => {
 ...
 {/* 유산소 운동 차트 */}
 <div className="bg-surface p-4 shadow rounded-lg overflow-hidden border border-line">
 <h2 className="text-lg font-semibold mb-4 text-content-tertiary pt-3">
 주별 유산소 운동량
 </h2>
