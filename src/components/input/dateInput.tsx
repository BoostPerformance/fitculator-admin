...
const DateInput = ({
 ...
 <div className="flex items-center justify-center relative bg-surface rounded-[2rem] border drop-shadow-sm h-[3.5rem] w-[14rem] ">
 <input
 type="text"
 value={selectedDate || ''}
 ...
 readOnly
 className="border px-[1.375rem] py-[0.75rem] rounded-[2rem] h-[3.5rem] drop-shadow-sm
