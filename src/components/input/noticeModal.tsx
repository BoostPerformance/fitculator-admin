...
export default function NoticeModal({
 ...
 <div className="bg-surface rounded-lg shadow-lg w-[90%] max-w-md p-6 relative">
 <button
 onClick={onClose}
 ...
 <input
 className="w-full border border-line rounded p-2 mb-4"
 placeholder="공지사항 제목"
 value={title}
 onChange={(e) => setTitle(e.target.value)}
 />
 <textarea
 className="w-full h-40 border border-line rounded p-2"
