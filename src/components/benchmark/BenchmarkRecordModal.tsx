...
// console.log('전송할 데이터:', recordData);
 ...
 disabled={isDisabled}
 />
 <span className="text-content-secondary">{benchmark.unit_label}</span>
 </div>
 );
 };
 ...
 {workoutsLoading ? (
 <div className="w-full px-3 py-2 border rounded-lg text-content-tertiary">
 운동 기록 불러오는 중...
 </div>
 ...
 type="button"
 onClick={onClose}
 className="flex-1 px-4 py-2 border border-line rounded-lg hover:bg-surface-raised"
 >
 취소
 </button>
 <button
