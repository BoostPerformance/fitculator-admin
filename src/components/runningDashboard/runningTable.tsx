...
> = ({
 ...
 <span className="text-xs text-content-tertiary ml-1">달성률</span>
 </div>
 ...
 <span className="text-xs text-content-tertiary ml-1">세션</span>
 </div>
 </div>
 </div>
 )}
 ...
 className="px-4 py-2 text-sm bg-surface border border-line rounded-lg disabled:opacity-50 disabled:cursor-not-allowed active:bg-surface-raised dark:active:bg-neutral-700"
 >
 이전
 </button>
 ...
 >
 <td className="p-3 text-center text-content-tertiary">
 ...
 <td
 key={`empty-${i}`}
 className={`p-3 text-center text-content-disabled ${
 isCurrent
 ? 'bg-blue-50 dark:bg-blue-900/30'
 : ''
 }`}
 ...
 disabled={!pagination.hasPrevPage}
 className="px-3 py-1.5 text-sm border border-line rounded-md hover:bg-surface-raised disabled:opacity-50 disabled:cursor-not-allowed"
 >
 처음
 </button>
 <button
