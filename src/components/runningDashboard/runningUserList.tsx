...
> = ({
 ...
 <div
 key={index}
 className="pt-[0rem] pb-[2rem] sm:bg-surface dark:sm:bg-neutral-800 rounded-md shadow cursor-pointer"
 onClick={() => {
 ...
 className="px-4 py-2 text-sm border border-line rounded-md hover:bg-surface-raised disabled:opacity-50 disabled:cursor-not-allowed"
 >
 이전
 </button>
