...
const ImageModal = ({ imageUrl, onClose }: ImageModalProps) => {
 ...
 <button
 className="absolute -left-10 top-0 text-white text-2xl font-bold hover:text-content-disabled"
 onClick={onClose}
 >
 ✕
 </button>
...
const MealPhotoLayout = ({
 ...
 <div className="w-full h-32 overflow-hidden rounded-lg flex flex-col items-center justify-center bg-surface-raised border-2 border-dashed border-line">
 <div className="text-content-disabled text-sm">식단이미지 없음</div>
 </div>
 );
