...
// console.error("Error submitting coach memo:", err);
 ...
 <h2 className="text-lg font-semibold text-content-primary">코치메모</h2>
 <button
 onClick={onClose}
 ...
 className="w-full h-40 sm:h-32 p-4 border border-line rounded-xl resize-none text-base focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:text-white transition-all"
