...
export const ChallengeDashboardSkeleton = () => {
 return (
 <div className="bg-surface-app flex flex-col h-screen overflow-hidden sm:px-[1rem] md:px-[0.4rem]">
 {/* 헤더 스켈레톤 */}
 ...
 {/* 사이드바 스켈레톤 */}
 <div className="w-[15rem] sm:w-full md:w-full p-4 bg-surface rounded-lg">
 ...
 <div
 key={i}
 className="col-span-2 bg-surface p-4 rounded-lg h-[300px]"
 >
...
export const DietPageSkeleton = () => {
 ...
 {/* 사이드바 스켈레톤 */}
 <div className="w-[15rem] sm:w-full md:w-full bg-surface p-6 shadow-sm border-r border-line">
 {/* 로고 스켈레톤 */}
 <div className="mb-8">
 <Skeleton className="h-8 w-32" />
 </div>
 ...
 {/* 메인 컨텐츠 스켈레톤 */}
 <main className="flex-1 px-[1rem] py-[1.25rem] sm:px-0 sm:py-0 bg-surface-app">
 ...
 {[...Array(8)].map((_, i) => (
 <div key={i} className="grid grid-cols-6 gap-4 py-4 border-b border-line-subtle sm:grid-cols-1 sm:gap-2">
...
export const MainPageSkeleton = () => {
 return (
 <div className="bg-surface-app flex flex-col min-h-screen sm:px-[1rem] md:px-[0.4rem]">
 <div className="flex gap-[1rem] flex-1 sm:flex-col md:flex-col">
 {/* 메인 컨텐츠 스켈레톤 (사이드바 없음) */}
 ...
 {[...Array(3)].map((_, i) => (
 <div key={i} className="bg-surface p-4 rounded-lg border-2">
 ...
 {/* 도넛 차트 스켈레톤 */}
 <div className="col-span-2 bg-surface p-4 rounded-lg h-[36rem]">
 ...
 {/* 테이블 섹션 스켈레톤 */}
 <div className="dark:bg-surface bg-surface-raised lg:pt-[1rem] bg-surface-app px-4 sm:px-4">
 <div className="bg-surface p-4 rounded-lg">
 <DietTableSkeleton />
 </div>
 </div>
 ...
 {/* Footer 스켈레톤 */}
 <div className="h-16 bg-surface border-t">
...
export const WorkoutPageSkeleton = () => {
 ...
 {/* 주별 유산소 운동량 카드 */}
 <div className="bg-surface rounded-lg p-4 shadow-sm border border-line">
 ...
 {/* 테이블 헤더 */}
 <div className="flex gap-4 mb-4 pb-3 border-b border-line">
 ...
 {/* 테이블 로우 */}
 {[...Array(8)].map((_, i) => (
 <div key={i} className="flex gap-4 py-3 border-b border-line">
 <Skeleton className="h-5 w-8" />
 <Skeleton className="h-5 w-16" />
 <Skeleton className="h-5 w-20" />
 {[...Array(6)].map((_, j) => (
 ...
 {[...Array(5)].map((_, i) => (
 <div key={i} className="pb-[2rem] bg-surface rounded-md shadow dark:shadow-none dark:border">
...
export const MobileChartSkeleton = () => {
 return (
 <div className="mt-[3rem] sm:bg-surface sm:px-[1rem] space-y-8">
 {[...Array(3)].map((_, i) => (
