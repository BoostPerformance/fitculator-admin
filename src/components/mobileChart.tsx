...
export default function MobileChart({
 ...
 } text-white rounded-[0.3rem] text-body font-medium`}
 >
...
// console.error('Date formatting error:', error);
 ...
 return (
 <div className="mt-[1rem] bg-transparent sm:bg-surface sm:px-[1rem]">
 ...
 className="text-content-tertiary text-title-lg font-bold pl-[1rem] pb-[1rem]"
 >
 {meal.user.name}
 </div>
 ...
 <thead>
 <tr className="grid grid-cols-6 gap-[0.4rem] text-content-disabled text-sm sm:text-title-lg font-medium">
 <th>아침</th>
 <th>점심</th>
 <th>저녁</th>
 <th>간식</th>
