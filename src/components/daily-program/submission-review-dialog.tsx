...
export function SubmissionReviewDialog({
 ...
 <div className="flex items-center gap-2">
 <span className="text-sm text-content-tertiary w-16">날짜</span>
 <span className="text-sm text-content-secondary">
 {program?.date || '-'}
 </span>
 </div>
 <div className="flex items-center gap-2">
 <span className="text-sm text-content-tertiary w-16">프로그램</span>
 <span className="text-sm text-content-secondary">
 {program?.title || '(제목 없음)'}
 </span>
 </div>
 <div className="flex items-center gap-2">
 <span className="text-sm text-content-tertiary w-16">카드</span>
 <span className="text-sm text-content-secondary">
 {card?.title || '-'}
 </span>
 </div>
 <div className="flex items-center gap-2">
 <span className="text-sm text-content-tertiary w-16">제출일</span>
 <span className="text-sm text-content-secondary">
