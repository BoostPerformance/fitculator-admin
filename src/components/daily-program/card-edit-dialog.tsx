...
export function CardEditDialog({
 ...
 <div className="bg-surface rounded-lg shadow-xl max-w-lg w-full max-h-[90vh] flex flex-col">
 {/* Header - fixed */}
 ...
 className={`px-2 py-1.5 text-sm border border-line rounded-md bg-surface font-medium ${
