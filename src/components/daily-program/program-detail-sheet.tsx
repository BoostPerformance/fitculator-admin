...
export function ProgramDetailSheet({
  ...
  return (
    <>
      ...
      {/* Sheet */}
      <div className="fixed inset-y-0 right-0 z-50 w-full max-w-2xl bg-white dark:bg-gray-900 shadow-xl overflow-y-auto animate-in slide-in-from-right duration-300">
        {/* Header */}
            ...
            <div className="border-t border-gray-200 dark:border-gray-700 pt-4 space-y-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="px-3 py-1.5 text-sm border border-red-300 dark:border-red-800 rounded-md hover:bg-red-50 dark:hover:bg-red-900/20 text-red-600 dark:text-red-400 transition-colors"
                >
                  삭제
                </button>
              </div>
