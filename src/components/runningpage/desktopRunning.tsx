...
export default function DesktopRunning({
 userId,
 userData,
 totalPoints,
 currentWeekData,
 ...
 <button
 className="pt-[6rem] text-content-disabled font-bold hover:font-extrabold cursor-pointer sm:px-[2rem] sm:hidden lg:block md:block"
 onClick={handleBack}
 >
 ← 목록으로
 </button>
