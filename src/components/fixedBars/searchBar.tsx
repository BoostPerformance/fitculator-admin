...
const SearchBar: React.FC<SearchBarProps> = ({ placeholder = 'Search' }) => {
 ...
 className="w-[30rem] pl-[2.5rem] pr-[1rem] py-[0.5rem] rounded-lg bg-surface-raised border border-line focus:outline-none focus:ring-2 focus:ring-blue-500 sm:w-[10rem]"
 />
 <div className="absolute left-[0.75rem] top-[0.5rem]">
 <svg
 xmlns="http://www.w3.org/2000/svg"
 className="h-[1.25rem] w-[1.25rem] text-content-tertiary"
 viewBox="0 0 20 20"
 fill="currentColor"
 >
 <path
