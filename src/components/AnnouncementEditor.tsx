...
export function AnnouncementEditor({ content, onChange }: AnnouncementEditorProps) {
 ...
 if (!editor) {
 return (
 <div className="announcement-editor border border-line rounded-lg">
 <div className="p-4 flex items-center justify-center min-h-[300px]">
 <Loader2 className="animate-spin text-content-disabled" size={24} />
 </div>
 </div>
 );
 }
 ...
 {/* 안내 문구 */}
 <div className="px-4 py-2 bg-surface-raised border-t border-line text-xs text-content-tertiary">
